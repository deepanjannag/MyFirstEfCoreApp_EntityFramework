    ...
    public static class Commands
    {
        ...
        public static void ListAllWithLogs()
        {
            ...
            using (var db = new AppDbContext())
            {
                ...
                {
                    var webUrl = entity.Author.WebUrl == null ? "- no web url given -" : entity.Author.WebUrl;
        ...
        public static void ChangeWebUrlWithLogs()
        {
            ...
            using (var db = new AppDbContext())
            {
                ...
                var singleBook = db.Books.Include(book => book.Author).Single(b => b.Title == "Quantum Networking");
                singleBook.Author.WebUrl = newWebUrl;
                db.SaveChanges();
